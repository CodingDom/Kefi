...
import {
  TravelNews,
  TravelNewsQueryParams,
} from "@core/interfaces/travel-news";
...
export class HomepageComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.metaTagService.updateTag({
      name: "description",
      content:
        "Book your dream vacation home anywhere in the world through Kefi Rentals.",
    });
  ...
  preloadDestinations(data) {
    ...
    data.forEach((d) => {
      ...
      img.onload = () => {
        loaded++;
        if (loaded === data.length) this.destinations = data;
      };
    });
  }
